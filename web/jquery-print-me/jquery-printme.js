...
jQuery.fn.printMe = function(options){
	...
	return this.each(function(){
		...
		// w.document.write('<link rel="stylesheet" href="/stylesheet/style-marathon.min.css">');
		// w.document.write('<link rel="stylesheet" href="/stylesheet/marathon-product.min.css">');
		// w.document.write('<link rel="stylesheet" href="/template/assets/font-awesome/css/font-awesome.min.css">');
		// Close the head
		...
		w.document.write('<script type="text/javascript">function closeme(){window.close();}setTimeout(closeme,50);</script></body></html>');
		w.print();
		w.document.close();
	});
}
