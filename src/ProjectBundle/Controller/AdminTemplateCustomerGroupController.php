...
use ProjectBundle\Form\Type\AdminTemplateCustomerGroupType;
...
class AdminTemplateCustomerGroupController extends Controller
{
	const ROUTER_INDEX = 'admin_template_customer_group';
	const ROUTER_ADD = self::ROUTER_INDEX.'_new';
	const ROUTER_EDIT = self::ROUTER_INDEX.'_edit';
	const ROUTER_CONTROLLER = 'AdminTemplateCustomerGroup';

	protected function getQuerySearchData($arr_query_data)
	{
		$repository = $this->getDoctrine()->getRepository(TemplateCustomerGroup::class);
    	$query = $repository->findAllDataJoinedCustomerGroup($arr_query_data);
		return $query;
	}
	...
	*/
	public function newAction(Request $request)
	{
		...
		$form = $this->createForm(AdminTemplateCustomerGroupType::class, new TemplateCustomerGroup());
	...
	*/
	public function createAction(Request $request)
	{
		...
		$data = new TemplateCustomerGroup();
		$form = $this->createForm(AdminTemplateCustomerGroupType::class, $data);
	...
	*/
	public function editAction(Request $request)
	{
		$util = $this->container->get('utilities');
		$util->setCkAuthorized();
		$data = $this->getDoctrine()->getRepository(TemplateCustomerGroup::class)->find($request->get('id'));
	...
	*/
	public function updateAction(Request $request)
	{
		...
		$data = $em->getRepository(TemplateCustomerGroup::class)->find($request->get('id'));
		if (!$data) { throw $this->createNotFoundException('No data found'); }
	...
	public function group_deleteAction(Request $request)
	{
		...
		if ($data_ids) {
			...
			foreach ($data_ids as $data_id) {
				$data = $em->getRepository(TemplateCustomerGroup::class)->find($data_id);
				if ($data) {
					try {
						$em->remove($data);
						$em->flush();
