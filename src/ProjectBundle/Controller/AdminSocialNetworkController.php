...
class AdminSocialNetworkController extends Controller
{
	...
	const ROUTER_INDEX = 'admin_social_network';
	const ROUTER_CONTROLLER = 'AdminSocialNetwork';
	...
	*/
	public function indexAction(Request $request)
	{
		...
		$group_datas = $repository->getDataByCatType('social_network')->getQuery()->getResult();
		$util->setBackToUrl();
