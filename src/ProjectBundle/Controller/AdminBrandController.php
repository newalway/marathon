...
use ProjectBundle\Form\Type\AdminBrandType;
...
{
	const ROUTER_INDEX = 'admin_brand';
	const ROUTER_ADD = self::ROUTER_INDEX.'_new';
	const ROUTER_EDIT = self::ROUTER_INDEX.'_edit';
	const ROUTER_PREFIX = 'brand';
	const ROUTER_CONTROLLER = 'AdminBrand';
	...
	*/
	public function newAction(Request $request)
	{
		...
		$form = $this->createForm(AdminBrandType::class, new Brand());
	...
	*/
	public function createAction(Request $request)
	{
		...
		$data = new Brand();
		$form = $this->createForm(AdminBrandType::class, $data);
	...
	*/
	public function editAction(Request $request)
	{
		$util = $this->container->get('utilities');
		$util->setCkAuthorized();
		$data = $this->getDoctrine()->getRepository(Brand::class)->find($request->get('id'));
	...
	*/
	public function updateAction(Request $request)
	{
		...
		$data = $em->getRepository(Brand::class)->find($request->get('id'));
		if (!$data) { throw $this->createNotFoundException('No data found'); }
	...
	public function group_deleteAction(Request $request)
	{
		...
		if ($data_ids) {
			...
			foreach ($data_ids as $data_id) {
				$data = $em->getRepository(Brand::class)->find($data_id);
				if ($data) {
					try {
						$em->remove($data);
						$em->flush();
