...
use ProjectBundle\Form\Type\AdminAgeGroupType;
...
class AdminAgeGroupController extends Controller
{
  ...
  */
  public function newAction(Request $request)
  {
		...
		$form = $this->createForm(AdminAgeGroupType::class, new AgeGroup());
  ...
  */
  public function createAction(Request $request)
  {
    ...
    $em = $this->getDoctrine()->getManager();
		...
		$data = new AgeGroup();
    $form = $this->createForm(AdminAgeGroupType::class, $data);
  ...
  */
  public function editAction(Request $request)
  {
    $util = $this->container->get('utilities');
		$util->setCkAuthorized();
		$data = $this->getDoctrine()->getRepository(AgeGroup::class)->find($request->get('id'));
  ...
  */
  public function updateAction(Request $request)
  {
    ...
    $em = $this->getDoctrine()->getManager();
		...
		$data = $em->getRepository(AgeGroup::class)->find($request->get('id'));
		if (!$data) { throw $this->createNotFoundException('No data found'); }
	...
	public function group_deleteAction(Request $request)
	{
		...
		if ($data_ids) {
			...
			foreach ($data_ids as $data_id) {
				$data = $em->getRepository(AgeGroup::class)->find($data_id);
				if ($data) {
					try {
						$em->remove($data);
				    $em->flush();
