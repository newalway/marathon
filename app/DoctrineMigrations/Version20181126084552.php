 ...
 */
class Version20181126084552 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE tracking_number (id INT AUTO_INCREMENT NOT NULL, order_number VARCHAR(255) NOT NULL, tracking_number VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
